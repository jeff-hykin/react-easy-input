...
var HandleChange, Input, Invalid, React, converterModule, converters, invalidModule, isInvalid, resetCursor, retrieveKeyValueNoExceptions;
...
Input = class Input extends React.Component {
  ...
  render() {
    var classAdd, className, converter, displayInvalid, each, expectedProps, i, incomingFilter, invalidStyle, len, linkTo, newProps, outgoingFilter, props, ref, valueIsInvalid;
    props = this.props;
    ...
    if (!newProps.onChange) {
      ...
      newProps.onChange = (e) => {
        ...
        resetCursor(this);
        return HandleChange(newProps.this, linkTo, incomingFilter)(e);
      };
    } else {
      newProps.onChange = (e) => {
        e.persist(); // react will destroy e if we don't tell it to persist
